...
import com.yijiupi.bi.kit.Injector;
...
public class BaseController {
    ...
    public BaseController setCookie(String name, String value) {
        return doSetCookie(name, value, null, null, null);
    }
    ...
    public BaseController setCookie(String name, String value, String path) {
        return doSetCookie(name, value, path, null, null);
    }
    ...
    private BaseController doSetCookie(String name, String value, String path, String domain, Boolean isHttpOnly) {
        Cookie cookie = new Cookie(name, value);
        // set the default path value to "/"
        if (path == null) {
            path = "/";
